...
$toEmail = "leonid.spb2015@yandex.ru"; // емайл получателя данных из формы
...
mail($toEmail, $tema, $message, "Сайт Car Musc"); //отправляет получателю на емайл значения переменных
